const ItemArticles = ({ address, name, date, title, image }) => {
  return (
    <div className="relative bg-white flex flex-col gap-3 pb-3 rounded-lg border border-[#EAEAEA] h-[370px]">
      <div className="relative ">
        ...
        <img
          src={image}
          alt=""
          className="object-cover w-full p-2 overflow-hidden rounded-2xl h-[200px]"
        />
      </div>
